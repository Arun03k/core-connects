...
class InputValidator:
    ...
    def validate_username(
        self, username: str, required: bool = False
    ) -> Dict[str, Any]:
        """Validate username"""
    ...
    def validate_registration_data(self, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        first_name_result = self.validate_name(
        ...
        last_name_result = self.validate_name(
            data.get("lastName") or data.get("last_name"), "Last name", required=False
        )
        ...
        return {"valid": len(errors) == 0, "errors": errors, "data": cleaned_data}
