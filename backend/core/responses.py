...
class APIResponse:
    ...
    def created(
        ...
        response, status_code = APIResponse.success(
            data=data, message=message, status_code=201
        )
...
class ErrorResponses:
    ...
    def conflict(message: str = "Resource conflict") -> tuple[Response, int]:
        ...
        return APIResponse.error(
            message=message, status_code=409, error_code="CONFLICT"
        )
    ...
    def internal_error(message: str = "Internal server error") -> tuple[Response, int]:
        ...
        return APIResponse.error(
            message=message, status_code=500, error_code="INTERNAL_ERROR"
        )
...
class AuthResponses:
    ...
    @staticmethod
    def login_success(
        user_data: Dict[str, Any], tokens: Dict[str, Any]
    ) -> tuple[Response, int]:
    ...
    def token_refresh_success(tokens: Dict[str, Any]) -> tuple[Response, int]:
        ...
        return APIResponse.success(data=tokens, message="Tokens refreshed successfully")
