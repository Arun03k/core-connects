    ...
    def generate_tokens(user_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                'token_type': 'Bearer',
                'refresh_expires_in': int(SecurityConfig.JWT_REFRESH_TOKEN_EXPIRES.total_seconds())
            }
...
class PasswordManager:
    ...
    def validate_password_strength(password: str) -> Dict[str, Any]:
        ...
        if len(password) < SecurityConfig.MIN_PASSWORD_LENGTH:
            requirements.append(f'Must be at least {SecurityConfig.MIN_PASSWORD_LENGTH} characters long')
        
        if len(password) > SecurityConfig.MAX_PASSWORD_LENGTH:
            requirements.append(f'Must not exceed {SecurityConfig.MAX_PASSWORD_LENGTH} characters')
        ...
        return {
            'is_valid': is_valid,
            'message': 'Password meets all requirements' if is_valid else 'Password does not meet security requirements',
