...
class TokenService:
    ...
    def generate_access_token(self, user_id: str, email: str, expires_in: Optional[int] = None) -> str:
    ...
    def generate_refresh_token(self, user_id: str, email: str, expires_in: Optional[int] = None) -> str:
        """Generate JWT refresh token"""
        now = datetime.now(timezone.utc)
        expires_in = expires_in or current_app.config.get('JWT_REFRESH_TOKEN_EXPIRES', 604800)
